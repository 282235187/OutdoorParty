      ...
      <div class="jumbotron" >
        ...
        <div class="row" >
          <div class="col-lg-2 col-lg-offset-4 col-md-offset-4 col-md-2 col-sm-offset-3 col-sm-3 col-xs-offset-3 col-xs-3">
            <p><a class="btn btn-success btn-lg"  role="button" data-toggle="modal" data-target="#registerForm">注&nbsp; 册</a> </p>
          </div>
          <div class="col-lg-2 col-md-6 col-sm-6">
            <p><a class="btn btn-primary btn-lg"  role="button"  data-toggle="modal" data-target="#loginForm">登 &nbsp;录</a> </p>
          </div>
        </div>
...
<%--注册模态框--%>
<div id="regresult">${studentInformation}</div>
<div id="reguser">${regusername}</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div style="padding: 20px 20px 20px 20px;">
                    <form class="bs-example bs-example-form" role="form" action="StudentRegisteradd.action" method="post">
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="input-group input-group-lg">
                                    <input type="text" class="form-control " id="regusername"  maxlength="20" name="regusername" placeholder="请输入账户名 " onblur="checkRegister()" onkeydown="clear1()">
                                </div><!-- /input-group -->
                            </div>
                            <div class="col-lg-4" >
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="input-group input-group-lg">
                                    <input type="password" class="form-control " value="" maxlength="20" name="regpassword" placeholder="请输入密码" onkeydown="clear1()">
                                </div>
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="row">
                            <div class=" col-lg-12">
                                <input type="submit" class="btn btn-block" value="注册">
                            </div>
                        </div>
                    </form>
                </div>
...
<%--<div class="mode fade" id="registerForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" style="width: 400px" >
        <div class="modal-content" >
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="myModalLabel0"><div><h2>用户注册</h2></div></h4>
            </div>
            <div class="modal-body" style="padding: 20px 20px 20px 20px">
                <form method="post"  class="bs-example bs-example-form">
                    <div class="row">
                        <div class="col-lg-10">
                            <div class="input-group input-group-lg">
                                <input type="text" class="form-control" name="regusername" placeholder="请输入用户名" onclick="clear1()">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-10">
                            <div class="input-group input-group-lg">
                                <input type="password" class="form-control" name="regpassword" placeholder="请输入密码"onclick="clear1()">
                            </div>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        <div class="col-lg-10">
                            <div class="input-group input-group-lg">
                                <input type="password" class="form-control" name="regpassword" placeholder="请确认密码"onclick="clear1()">
                            </div>
                        </div>
                    </div>
                    <br>
...
<!-- 模态框（Modal） -->
<div id="result" >${studentInformation}</div>
